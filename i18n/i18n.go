...
func InitI18n() {
	...
	if _, err := bundle.LoadMessageFile("E:\\project\\cer\\MuseBot\\conf\\i18n\\i18n.en.json"); err != nil {
		logger.Error("Failed to load English translation file", "err", err)
	}
	// Chinese translations
	if _, err := bundle.LoadMessageFile("E:\\project\\cer\\MuseBot\\conf\\i18n\\i18n.zh.json"); err != nil {
